    ...
    render() {
        ...
        return (
            <div className="input-group" style={{width:'250px'}}>
                <input type="text" value={this.props.searchTerm} className="form-control" placeholder="Search" aria-describedby="searchIcon" onChange={this.props.onSearchTermChanged}/>
